...
ScranAdvisor.prototype.findRestaurantByName = function(name) {
    return this.restaurants.find(restaurant => restaurant.name === name); // this line can be assigned to a variable to improve readability (e.g. const = foundRestearunt) --> return this variable after prcoessing the find method
  };
...
// Thinking process:
// Create object to store count of each cusiine type using key-value pairs
...
// Model solution for Extensions 1

ScranAdvisor.prototype.mostCommonCuisine = function(){
  // loop through each restaraunt
  // for each restaraunt - loop throught the cuisines
  // counting instances of cuisines as i go
  ...
  // trackingCuisine is the accumulator of the reduce() method
  const mostCommonCuisine = Object.keys(cuisineCounter).reduce((trackingCuisine, nextCuisine) => cuisineCounter[trackingCuisine] > cuisineCounter[nextCusine] ? trackingCuisine : nextCuisine);
...
// Model solution for Extensions 2
